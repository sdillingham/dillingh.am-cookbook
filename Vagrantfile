...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "#{session_username.gsub("_", "-")}-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/dillingham"
  #   chef.validation_client_name = "dillingham-validator"
  #   chef.validation_key_path = ".chef/dillingham-validator.pem"
  # end
end
